...
export default function FilterBar({ filters, inboxes, onChange }: FilterBarProps) {
  return (
    <div className="grid grid-cols-1 gap-3 rounded-xl border border-slate-800 bg-slate-900/50 p-3 sm:grid-cols-2 sm:p-4 xl:grid-cols-3 2xl:grid-cols-5">
      <label className="flex min-w-0 flex-col gap-1 text-xs text-slate-400 sm:col-span-2 xl:col-span-1">
        Search
        <input
          type="search"
